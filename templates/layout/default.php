...
<body>
  ...
  <div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav class="h-14 bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="<?= $this->Url->build('/') ?>" class="flex items-center justify-between mr-4">
            <img
              src="<?= $this->Url->image('fav-cloudpe-logo.svg'); ?>"
              class="mr-3 h-8"
              alt="Flowbite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CloudPe</span>
          </a>
        ...
        <div class="flex items-center lg:order-2">
          ...
          <div
            ...
            <div class="py-3 px-4">
              <span
                class="block text-sm font-semibold text-gray-900 dark:text-white"><?= h($auth['name']) ?></span>
              <span
                class="block text-sm text-gray-900 truncate dark:text-white"><?= h($auth['email']) ?></span>
            </div>
            <ul
    ...
    <aside
      ...
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'virtuozzoUsers']) ?>"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg
                aria-hidden="true"
                class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              ...
              <span class="ml-3">Virtuozzo Users</span>
            </a>
          </li>
          <li>
            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'hostbillUsers', '?' => ['perpage' => '200']]) ?>"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg
                aria-hidden="true"
                class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              ...
              <span class="ml-3">Hostbill Users</span>
            </a>
          </li>
          <li>
            <a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'missmatch_users']) ?>"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg
                aria-hidden="true"
                class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              ...
              <span class="ml-3">Missmatch Users</span>
            </a>
          </li>
    ...
    <main class="mt-14 md:ml-64 h-auto">
    <?= $this->fetch('content') ?>
    </main>
  </div>
